            ...
            | true ->
                ...
                comp<RadzenStack> {
                    ...
                    comp<RadzenStack> {
                        ...
                        Button.render this this.Forget false this.ForgetLabel
                        Button.render this this.Save false this.SaveLabel
                        Button.render this this.Finish false this.FinishLabel
                    }
                }
